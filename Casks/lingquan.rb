cask "lingquan" do
  ...
  if Hardware::CPU.arm?
    url "https://updater-1305474371.cos.ap-guangzhou.myqcloud.com/download/%E9%9B%B6%E6%B3%89-#{version}-arm64.dmg",
        verified:   "updater-1305474371.cos.ap-guangzhou.myqcloud.com"
  else
    url "https://updater-1305474371.cos.ap-guangzhou.myqcloud.com/download/x64/%E9%9B%B6%E6%B3%89-#{version}.dmg",
    verified:   "updater-1305474371.cos.ap-guangzhou.myqcloud.com"
  end
