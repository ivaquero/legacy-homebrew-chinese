cask "messauto" do
    ...
    name "MessAuto"
    desc "MessAuto is a macOS app that automatically extracts and pastes and enters SMS verification codes. It is 100% developed with Rust and is suitable for any app. It is a free alternative to 2FHey."
